...
public static void subscribe(String cookie) {
    try {
        ...
        /*SOAPElement param2 = soapElement.addChildElement("gecos", "ns");
        param2.addTextNode("Skeeter Valentine");
        param2.addAttribute(new QName("xsi:type"), "xsd:string");
        //param2.addAttribute(new QName("xsi:type"), value:"xsd:minOccurs="O"");*/
