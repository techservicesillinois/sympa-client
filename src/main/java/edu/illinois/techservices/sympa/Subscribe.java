...
/**
 * 1. Demonstrates the Sympa API call to subscribe the current user to a list.
 * 
 * <P>
...
public class Subscribe implements Runnable {
     ...
     * 
     * @param args This program takes a command line argument of the listname. 
     */
    public static void main(String[] args) {
        if (args.length != 1) {
            System.err.println(
                    "Usage: mvn -q exec:java -Dexec.mainClass=edu.illinois.techservices.sympa.Subscribe -Dexec:args=<listName>");
            System.exit(0);
        }
        Subscribe app = new Subscribe(args);
        app.run();
