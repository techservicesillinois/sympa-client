...
/**
 * How to execute:
 * mvn exec:java -Dexec.mainClass="edu.illinois.techservices.sympa.demo.Which"
 ...
 * valued.
 */
public class Which implements Runnable {
   ...
   * api is successful, the SOAPMessage for this class will be set and can be
   ...
   * the current user. Returns data in a semicolon-delimited format.
   * 
   * <P>
